...
final class ChronicleUITests: XCTestCase {
    ...
    func testDashboardTimelineReviewFocusSmoke() throws {
        ...
        XCTAssertTrue(app.descendants(matching: .any)["timeline.nextAction"].waitForExistence(timeout: 5))
        XCTAssertTrue(app.descendants(matching: .any)["timeline.next.status"].waitForExistence(timeout: 5))
        XCTAssertTrue(app.buttons["timeline.next.primary"].waitForExistence(timeout: 5))
        XCTAssertTrue(app.staticTexts["Suggested next"].waitForExistence(timeout: 5))
        XCTAssertTrue(app.staticTexts["Leave one useful note while the range is still empty."].waitForExistence(timeout: 5))
    ...
    func testDashboardMarkersReviewNotesSmoke() throws {
        ...
        XCTAssertTrue(app.descendants(matching: .any)["dashboard.markers.nextAction"].waitForExistence(timeout: 5))
        XCTAssertTrue(app.descendants(matching: .any)["dashboard.markers.nextAction.status"].waitForExistence(timeout: 5))
    ...
    func testReportsReviewPlanSmoke() throws {
        ...
        XCTAssertTrue(app.descendants(matching: .any)["reports.workspace.nextAction"].waitForExistence(timeout: 5))
        XCTAssertTrue(app.staticTexts["Next: choose a Daily Log folder"].waitForExistence(timeout: 5))
    ...
    func testSupportReadinessReportSmoke() throws {
        ...
        XCTAssertTrue(app.descendants(matching: .any)["support.releaseSafety.facts"].waitForExistence(timeout: 5))
        XCTAssertTrue(app.descendants(matching: .any)["support.releaseSafety.facts.trigger"].waitForExistence(timeout: 5))
        XCTAssertTrue(app.descendants(matching: .any)["support.releaseSafety.facts.verify"].waitForExistence(timeout: 5))
        XCTAssertTrue(app.descendants(matching: .any)["support.releaseSafety.facts.recovery"].waitForExistence(timeout: 5))
        XCTAssertTrue(app.descendants(matching: .any)["support.releaseSafety.facts.candidate"].waitForExistence(timeout: 5))
